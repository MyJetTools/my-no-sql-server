...
use crate::{
    app::AppContext, background::tcp_connection_send_event_loop::TcpConnectionSendEventLoop,
...
impl DataReadersList {
    ...
    pub async fn add_tcp(&self, tcp_connection: Arc<MyNoSqlTcpConnection>, app: &Arc<AppContext>) {
